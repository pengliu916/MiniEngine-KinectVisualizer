...
public:
    ...
    void UpdateCB(DirectX::XMFLOAT2 ColReso, DirectX::XMFLOAT2 DepReso,
        DirectX::XMFLOAT4 ColFC, DirectX::XMFLOAT4 DepFC,
        DirectX::XMMATRIX Dep2Col);
    void OnRender(GraphicsContext& gfxContext, ColorBuffer* pDepthMap,
        ColorBuffer* pColorMap, DirectX::XMMATRIX viewProj);
    void RenderGui();

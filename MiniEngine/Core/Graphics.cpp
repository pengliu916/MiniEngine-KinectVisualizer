...
namespace Graphics
{
    ...
    void Init() {
        ...
        Core::g_config.swapChainDesc.BufferUsage =
    ...
    HRESULT CreateResource() {
        ...
        g_DepthStateDisabled.StencilWriteMask =
            D3D12_DEFAULT_STENCIL_WRITE_MASK;
        g_DepthStateDisabled.FrontFace.StencilFunc =
        ...
        g_DepthStateDisabled.FrontFace.StencilDepthFailOp =
        ...
        V(Graphics::CompileShaderFromFile(Core::GetAssetFullPath(
            _T("Graphics.hlsl")).c_str(), macro,
            D3D_COMPILE_STANDARD_FILE_INCLUDE, "vsmain", "vs_5_1",
            compileFlags, 0, &QuadVS));
        macro[0].Definition = "0";
        macro[1].Definition = "1";
        V(Graphics::CompileShaderFromFile(Core::GetAssetFullPath(
            _T("Graphics.hlsl")).c_str(), macro,
            D3D_COMPILE_STANDARD_FILE_INCLUDE, "psmain", "ps_5_1",
            compileFlags, 0, &CopyPS));
    ...
    void UpdateGUI() {
        ...
        float memBudget =
            Graphics::g_stats.localVideoMemoryInfo.Budget / 1048576.f;
        float memUsed =
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            ImGui::Text("%d", Graphics::g_stats.allocatorCreated[i]);
            ImGui::NextColumn();
            ImGui::Text("%d", Graphics::g_stats.allocatorReady[i]);
            ImGui::NextColumn();
        }
        ImGui::Columns(1);
        ImGui::Separator();
        ...
        ImGui::Text("%d", Graphics::g_pRTVDescriptorHeap->Size());
        ImGui::NextColumn();
        ImGui::Text("DSVDescriptor"); ImGui::NextColumn();
        ImGui::Text("%d", Graphics::g_pDSVDescriptorHeap->Size());
        ImGui::NextColumn();
        ImGui::Text("SMPDescriptor"); ImGui::NextColumn();
        ImGui::Text("%d", Graphics::g_pSMPDescriptorHeap->Size());
        ImGui::NextColumn();
        ImGui::Text("CSUDescriptor"); ImGui::NextColumn();
        ImGui::Text("%d", Graphics::g_pCSUDescriptorHeap->Size());
        ImGui::NextColumn();
        ...
        ImGui::Columns(1);
        ImGui::Separator();
        ImGui::Text("RenderThread Stall Count: %d/frame  Time:%4.2fms",
